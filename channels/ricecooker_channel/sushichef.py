...
# CHANNEL SETTINGS
SOURCE_DOMAIN = "learningequality.org"                 # content provider's domain
SOURCE_ID = "sample-ricecooker-channel-dev"                             # an alphanumeric channel ID
...
SAMPLE_PERSEUS_3_JSON = open(join(DATA_DIR,'literary_passage.json'),'r').read()
SAMPLE_PERSEUS_4_JSON = open(join(DATA_DIR,'sample_perseus04.json'),'r').read()
                ...
                "questions": [
                    {
                        ...
                        "item_data":SAMPLE_PERSEUS_4_JSON,
                    },
                ],
            },
            {
